...
export default function WaterTracker() {
  ...
  const saveToLocalStorage = () => {
    if (localStorage.drinkTime) {
      ...
      localStorage.drinkTime = new Date().toLocaleTimeString(
        navigator.language,
  ...
  const handleClick = () => {
    ...
    newTargetData[day] =
      (targetData[day] != undefined ? targetData[day] : 0) + 1;
      ...
      <Grid item xs={12} sm={6}>
        <Card id="leftCard" className="whiteBox waterCard">
          ...
          <div className="info-txt">
            Click on the circle to confirm that you have just drunk one glass of
            water
          </div>
        </Card>
      </Grid>
